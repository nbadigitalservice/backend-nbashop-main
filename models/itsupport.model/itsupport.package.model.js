...
const itsupportpackage = new mongoose.Schema({
...
const ItsupportPackage = new mongoose.model("itsupportpackage",itsupportpackage)
...
module.exports = { ItsupportPackage,validate }