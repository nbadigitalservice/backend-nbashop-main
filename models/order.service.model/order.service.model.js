...
const validate = (data) => {
  const Schema = Joi.object({
    customer_name: Joi.string()
      .required()
      .allow("")
      .label("โปรดกรอกชื่อลูกค้า"),
    customer_tel: Joi.string()
      .required()
      .allow("")
      .label("โปรดกรอกเบอร์โทรลูกค้า"),
    customer_address: Joi.string()
      .required()
      .allow("")
      .label("โปรดกรอกที่อยู่ลูกค้า"),
    customer_iden_id: Joi.string()
      .required()
      .allow("")
      .label("โปรดกรอกรหัสบัตรประชาชนลูกค้า"),
    customer_line: Joi.string()
      .required()
      .allow("")
      .label("โปรดกรอกไลน์ลูกค้า"),
    shopid: Joi.string().required().allow("").label("โปรดกรอกidลูกค้า"),
    shop_partner_type: Joi.string()
      .required()
      .allow("")
      .label("โปรดกรอกประเภทของพาร์ทเนอร์"),
