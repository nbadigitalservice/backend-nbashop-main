...
const buysimDTACPackage = new mongoose.Schema({
...
const BuysimDTACPackage = new mongoose.model('buysimdtacpackage', buysimDTACPackage)
...
module.exports = { BuysimDTACPackage, validate }