...
const buysimTRUEPackage = new mongoose.Schema({
...
const BuysimTRUEPackage = new mongoose.model('buysimtruepackage', buysimTRUEPackage)
...
module.exports = { BuysimTRUEPackage, validate }