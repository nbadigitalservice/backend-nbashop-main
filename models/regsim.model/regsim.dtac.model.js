...
const regsimDTACPackage = new mongoose.Schema({
...
const RegsimDTACPackage = new mongoose.model('regsimdtacpackage', regsimDTACPackage)
...
module.exports = { RegsimDTACPackage, validate }