...
const regsimTRUEPackage = new mongoose.Schema({
...
const RegsimTRUEPackage = new mongoose.model('regsimtruepackage', regsimTRUEPackage)
...
module.exports = { RegsimTRUEPackage, validate }