...
const accountpackage = new mongoose.Schema({
...
const AccountPackageModel = new mongoose.model("accountpackage", accountpackage)
...
module.exports = { AccountPackageModel, validate }