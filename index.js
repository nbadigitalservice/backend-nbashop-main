...
app.use("/v1/nba-shop/image/collection", require("./routes/pos/uploadfile.collection"));
// Line Notify
...
app.use("/v1/nba-shop/preorder/shop-full", require("./routes/pos/preorder.shop.full"));
...
app.use("/v1/nba-shop/product/request", require("./routes/pos/product.request"));

app.use("/v1/nba-shop/product/reference", require("./routes/pos/product.reference"));
...
//datach service
app.use("/v1/nba-shop/detachservice", require("./routes/detachsevice/index"));
