const { RegsimTRUEPackage, validate } = require('../../models/regsim.model/regsim.true.model');
const fs = require('fs');
    ...
    try {
        ...
        upload(req, res, async function (err) {
            ...
            if (!req.files) {
                ...
                const regsimtruepackage = new RegsimTRUEPackage(data);
                regsimtruepackage.save(error => {
                    if (error) {
...
module.exports.GetAll = async (req, res) => {
    try {
        const regsimservice = await RegsimTRUEPackage.find();
...
module.exports.GetById = async (req, res) => {
    try {
        const regsimservice = await RegsimTRUEPackage.findById(req.params.id);
        if (!regsimservice) {
...
module.exports.update = async (req, res) => {
    try {
        ...
        const packageUpdate = await RegsimTRUEPackage.findById(id);
        ...
        upload(req, res, async function (err) {
            ...
            if (!req.files) {
                ...
                RegsimTRUEPackage.findByIdAndUpdate(id, data, { returnDocument: 'after' }, (err, result) => {
                    if (err) {
...
module.exports.delete = async (req, res) => {
    try {
        const id = req.params.id;
        RegsimTRUEPackage.findByIdAndDelete(id, { returnOriginal: true }, (err, result) => {
            if (err) {
