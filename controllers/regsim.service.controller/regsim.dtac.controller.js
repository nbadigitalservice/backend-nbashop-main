const { RegsimDTACPackage, validate } = require('../../models/regsim.model/regsim.dtac.model');
const fs = require('fs');
    ...
    try {
        ...
        upload(req, res, async function (err) {
            ...
            if (!req.files) {
                ...
                const regsimdtacpackage = new RegsimDTACPackage(data);
                regsimdtacpackage.save(error => {
                    if (error) {
...
module.exports.GetAll = async (req, res) => {
    try {
        const regsimservice = await RegsimDTACPackage.find();
...
module.exports.GetById = async (req, res) => {
    try {
        const regsimservice = await RegsimDTACPackage.findById(req.params.id);
        if (!regsimservice) {
...
module.exports.update = async (req, res) => {
    try {
        ...
        const packageUpdate = await RegsimDTACPackage.findById(id);
        ...
        upload(req, res, async function (err) {
            ...
            if (!req.files) {
                ...
                RegsimDTACPackage.findByIdAndUpdate(id, data, { returnDocument: 'after' }, (err, result) => {
                    if (err) {
...
module.exports.delete = async (req, res) => {
    try {
        const id = req.params.id;
        RegsimDTACPackage.findByIdAndDelete(id, { returnOriginal: true }, (err, result) => {
            if (err) {
