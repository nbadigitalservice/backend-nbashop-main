                  ...
                  if (data) {
                    ...
                    commission.save((error, data) => {
                      ...
                      const wallethistory = {
                        ...
                        partner_id: 'platform',
                        orderid: order._id,
                        name: `รายการสั่งซื้อ Insurance Service(ประกัน) ใบเสร็จเลขที่ ${order.receiptnumber}`,
                        type: 'เงินออก',
                    ...
                    if (data) {
                      ...
                      commission.save((error, data) => {
                        ...
                        const wallethistory = {
                          ...
                          orderid: findorderid._id,
                          name: `รายการสั่งซื้อ Insurance Service(ประกัน) ใบเสร็จเลขที่ ${findorderid.receiptnumber}`,
                          type: 'เงินออก',
