        ...
        if (err) {
          jwt.verify(token, process.env.API_PARTNER_KEY, async (err, partner_decoded) => {
            ...
            if (err) {
              ...
              const totalplateformprofit = websitepackage.plateformprofit * req.body.product_detail[0].quantity
              ...
              let data = {
                ...
                product_detail: [{
                  ...
                  packagename: websitepackage.name,
                  packagedetail: websitepackage.detail,
                  ...
                  if (data) {
                    ...
                    commission.save((error, data) => {
                      ...
                      const wallethistory = {
                        ...
                        partner_id: 'platform',
                        orderid: order._id,
                        name: `รายการสั่งซื้อ Website Service ใบเสร็จเลขที่ ${order.receiptnumber}`,
                        type: 'เงินออก',
