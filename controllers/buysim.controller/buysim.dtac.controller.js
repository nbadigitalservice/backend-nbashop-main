const { BuysimDTACPackage, validate } = require('../../models/buysim.model/buysim.dtac.package.model');
const fs = require('fs');
    ...
    try {
        ...
        upload(req, res, async function (err) {
            ...
            if (!req.files) {
                ...
                const buysimdtacpackage = new BuysimDTACPackage(data);
                buysimdtacpackage.save(error => {
                    if (error) {
...
module.exports.GetAll = async (req, res) => {
    try {
        const buysimservice = await BuysimDTACPackage.find();
...
module.exports.GetById = async (req, res) => {
    try {
        const buysimservice = await BuysimDTACPackage.findById(req.params.id);
        if (!buysimservice) {
...
module.exports.update = async (req, res) => {
    try {
        ...
        const packageUpdate = await BuysimDTACPackage.findById(id);
        ...
        upload(req, res, async function (err) {
            ...
            if (!req.files) {
                ...
                BuysimDTACPackage.findByIdAndUpdate(id, data, { returnDocument: 'after' }, (err, result) => {
                    if (err) {
...
module.exports.delete = async (req, res) => {
    try {
        const id = req.params.id;
        BuysimDTACPackage.findByIdAndDelete(id, { returnOriginal: true }, (err, result) => {
            if (err) {
