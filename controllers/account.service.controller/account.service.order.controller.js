        ...
        if (err) {
          jwt.verify(token, process.env.API_PARTNER_KEY, async (err, partner_decoded) => {
            ...
            if (err) {
              ...
              const totalprice = accountpackage.price * req.body.product_detail[0].quantity
              const change = req.body.moneyreceive - totalprice
              const totalplateformprofit = accountpackage.plateformprofit * req.body.product_detail[0].quantity
              ...
              let data = {
                ...
                totalCost: accountpackage.cost + accountpackage.nbaprofit,
                  ...
                  if (data) {
                    ...
                    commission.save((error, data) => {
                      ...
                      const wallethistory = {
                        ...
                        partner_id: 'platform',
                        orderid: order._id,
                        name: `รายการสั่งซื้อ Account Service ใบเสร็จเลขที่ ${order.receiptnumber}`,
                        type: 'เงินออก',
                    ...
                    if (data) {
                      ...
                      commission.save((error, data) => {
                        ...
                        const wallethistory = {
                          ...
                          orderid: findorderid._id,
                          name: `รายการสั่งซื้อ Account Service ใบเสร็จเลขที่ ${findorderid.receiptnumber}`,
                          type: 'เงินออก',
